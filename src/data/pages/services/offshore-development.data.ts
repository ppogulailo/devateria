...
export const offshoreOdcData = {
    hero: {
        title: "Offshore Software <br/> Development Center",
        subtitle:
            "We’re here to help you save time and beat the competition. By leveraging a dedicated offshore teams’ experience and expertise, your company will dramatically expand its capacity to achieve short and long-term business objectives.",
...
onboarding, and addressing accounting matters.`,
    ...
    faqItems: <FAQItem[]>[
        ...
        },
        {
            ...
            answer:
                "Successful remote hiring requires clear communication, defined responsibilities, and a reliable workflow...",
        },
        {
            question: "What Specialists Work at Your Service?",
            answer:
                "Frontend & backend developers, QA, DevOps, UI/UX designers, PMs, analysts...",
        },
        {
            question: "Why Should I Hire a Complete Team?",
            answer:
                "A full dedicated team offers better synergy, faster execution, and clearer communication...",
        },
        {
            question: "Where Do You Source Team Members From?",
            answer:
                "We recruit engineers from top European tech hubs with excellent education and strong communication skills.",
        },
        {
            question: "Why Choose Deveteria?",
            answer:
                "Fast team assembly, transparent pricing, senior engineers, flexible scaling...",
        },
    ],
};
