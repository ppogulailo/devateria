...
export const OurTechStackSection = () => {
    ...
    return (
        <section className="our_stacks bg-[--color-bg-alt] pt-24">
            <div className="container mx-auto max-w-6xl px-4">
                ...
                <div className="mb-10 flex w-full rounded-full border border-[--color-muted]/20 bg-[--color-bg] ">
                    <button
                        ...
                        className={`cursor-pointer flex-1 rounded-full px-6 py-3 text-center text-sm font-semibold transition-all duration-300
    ${activeTab === "software"
